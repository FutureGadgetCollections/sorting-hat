...
// quantityHeader: 'Add to Quantity' (TCGPlayer — incremental) or
//                 'Total Quantity'  (Manapool — replaces existing)
function buildCsv(rows, quantityHeader = 'Add to Quantity') {
  const headers = ['TCGplayer Id', quantityHeader, 'TCG Marketplace Price'];
